-- Part 3: Create multi-setter sets, QA monitoring, and machine transfers

-- Create multi-setter sets for multi-setter machines with correct enum casing
...
INSERT INTO machine_transfers (batch_id, from_machine_id, to_machine_id, transfer_date, transfer_time, days_in_previous_machine, notes)
SELECT 
  b.id as batch_id,
