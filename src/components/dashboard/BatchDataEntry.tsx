...
const BatchDataEntry = ({ batchId }: BatchDataEntryProps) => {
    ...
    return (
      <Card>
        <CardContent className="p-8 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Select a Hatchery</h3>
          <p className="text-gray-600">Choose a hatchery from the list above to start entering data.</p>
        </CardContent>
      </Card>
    );
  }
  ...
  return (
    <div className="space-y-6">
      {/* Hatchery Info Header */}
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>Hatchery: {batchInfo.batch_number}</CardTitle>
