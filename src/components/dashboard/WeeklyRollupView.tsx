                ...
                <TableBody>
                  {data.map((row) => (
                    ...
                    >
                      ...
                      <TableCell className="text-right">{fmtPct(row.grade_a_pct)}</TableCell>
                      <TableCell className="text-right">{fmtPct(row.fertility_pct)}</TableCell>
                      <TableCell className="text-right">{fmtPct(row.hof_pct)}</TableCell>
                      <TableCell className="text-right">{fmtPct(row.hoi_pct)}</TableCell>
                      <TableCell>
