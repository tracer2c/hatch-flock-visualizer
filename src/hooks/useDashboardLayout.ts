...
export const DEFAULT_LAYOUTS: Layouts = {
  lg: [
    ...
    { i: "metric-hoi", x: 0, y: 4, w: 4, h: 2, minW: 3, minH: 2 },
    { i: "houses-pipeline", x: 4, y: 4, w: 8, h: 4, minW: 4, minH: 3 },
    { i: "qa-alerts", x: 0, y: 8, w: 5, h: 4, minW: 3, minH: 3 },
    { i: "weekly-flock-status", x: 5, y: 8, w: 7, h: 4, minW: 4, minH: 3 },
  ],
  md: [
    { i: "eggs-hero", x: 0, y: 0, w: 10, h: 4 },
    { i: "metric-fertility", x: 0, y: 4, w: 5, h: 2 },
    { i: "metric-hatch", x: 5, y: 4, w: 5, h: 2 },
    { i: "metric-hoi", x: 0, y: 6, w: 10, h: 2 },
    { i: "houses-pipeline", x: 0, y: 8, w: 10, h: 4 },
    { i: "qa-alerts", x: 0, y: 12, w: 5, h: 4 },
    { i: "weekly-flock-status", x: 5, y: 12, w: 5, h: 4 },
  ],
  sm: [
    { i: "eggs-hero", x: 0, y: 0, w: 6, h: 4 },
    { i: "metric-fertility", x: 0, y: 4, w: 6, h: 2 },
    { i: "metric-hatch", x: 0, y: 6, w: 6, h: 2 },
    { i: "metric-hoi", x: 0, y: 8, w: 6, h: 2 },
    { i: "houses-pipeline", x: 0, y: 10, w: 6, h: 4 },
    { i: "qa-alerts", x: 0, y: 14, w: 6, h: 4 },
    { i: "weekly-flock-status", x: 0, y: 18, w: 6, h: 4 },
  ],
};
